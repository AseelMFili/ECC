...
?>
    ...
    <body>
        ...
        <div class="card" style="hieght: 600px; width: 600px; margin-left: auto; margin-right: auto; margin-bottom: 50px;">
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div class="list-group-item" v-for="item,key in bill">
                                            <div class="row">
                                                ...
                                                <div class="col">Bill id: {{item.id}}</div>
                                            </div>
                             ...
                             <button type="button" onclick="window.location.href='https://ecc-test-aseelmfili.c9users.io/newOrderPage.php'" style="margin-left:1000px; background-color:cadetblue;color:white;">Done!</button>
